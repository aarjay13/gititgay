...
def PHList(url):
    ...
    for videopage, name, img in match:
        ...
        if name.lower().find('ts ') == -1 and name.lower().find(' ts') == -1 and name.lower().find('tran') == -1 and name.lower().find('lady') == -1  and name.lower().find('girl') == -1 and name.lower().find('she') == -1:
