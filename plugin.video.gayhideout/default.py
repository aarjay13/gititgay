...
gotporn ='http://www.gotporn.com/gay'
...
def main():
	...
	#(removing gotporn for now, because GayHideout can't handle cookies)
	add_dir('Gotporn [COLOR yellow] GAY[/COLOR]', gotporn + '/?duration=20-&page=1', 2, logos + 'gotporn.png', fanart)
	...
	add_dir('LubeTube [COLOR yellow] Videos[/COLOR]', lubetube + '/', 2, logos + 'lubetube.png', fanart) 
	...
	add_dir('Pornsocket [COLOR yellow] GAY[/COLOR]', pornsocket + '/categories-media/21-gay.html?display=list&filter_mediaType=4&limitstart=0', 2, logos + 'pornsocket.png', fanart)	#/media-gallery.html?display=list&filter_mediaType=4&limitstart=0
	...
	add_dir('Upornia [COLOR yellow] GAY[/COLOR]', upornia + '/categories/gay/1/', 2, logos + 'upornia.png', fanart) #latest-updates/
	add_dir('ViKiPorn [COLOR yellow] Videos[/COLOR]', vikiporn + '/latest-updates/', 2, logos + 'vikiporn.png', fanart) 
	add_dir('xHamster [COLOR yellow] Videos[/COLOR]', xhamster + '/channels/new-amateur_gays-1.html', 2, logos + 'xhamster.png', fanart)
	...
	add_dir('YouJizz [COLOR yellow] GAY[/COLOR]', youjizz + '/setFilter.php?filter=gay', 2, logos + 'youjizz.png', fanart) # /newest-clips/1.html
	add_dir('YouPorn [COLOR yellow] GAY[/COLOR]', youporn + '/browse/time/', 2, logos + 'youporn.png', fanart)	
	add_dir('ZBPorn [COLOR yellow] GAY[/COLOR]', zbporn + '/categories/gays/', 2, logos + 'zbporn.png', fanart) #/latest-updates/
